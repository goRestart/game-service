...
final class GameConsoleControllerSpec: XCTestDatabasePreparations  {
  ...
  func test_should_not_found_if_game_console_was_not_found() throws {
    let request = Request(
      method: .get,
...
extension GameConsoleControllerSpec {
  static let allTests = [
    ...
    ("test_should_not_found_if_game_console_was_not_found", test_should_not_found_if_game_console_was_not_found),
